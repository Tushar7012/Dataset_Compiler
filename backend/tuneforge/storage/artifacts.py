...
class ArtifactStore:
    def __init__(self, base_dir: Path):
        ...
        # ponytail: one global lock serializes every filesystem-mutating call
        # on this store (import vs. delete race). Fine for a single-user
        # local app; move to per-project locks if that stops being true.
